...
class ChatGoogle(BaseChatModel):
	...
	# Internal client cache to prevent connection issues (initialized in __post_init__)
	_client: genai.Client | None = None

	def __post_init__(self):
		"""Initialize the _client field after dataclass initialization"""
		# Ensure _client is set to None if not already initialized
		# This prevents issues with dataclass field initialization
